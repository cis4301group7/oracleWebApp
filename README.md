# Major League Baseball Statistics Web App

CIS4301 Group 7 - Major League Baseball Web Statistics App

This is a web app that displays Major League Baseball statistics from a 2016 dataset.


- [Major League Baseball App](#major-league-baseball-statistics-web-app)
...
This project is focused on creating a web application for querying Oracle's Database to display Major League Baseball statistics. 

Features:
- Homepage 
- Page 2
  - Info on page 2
  - More features for page 2
...
This javascript web application requires the yarn package manager. To fully install the app:
...
git clone https://github.com/cis4301group7/oracleWebApp
...
Currently using OracleDB to manage the externally stored data. 
...
This app utilizes OracleDB as its source for data. Configuration details can be found in **src/config**. More information about OracleDB installation can be found [here](https://oracle.github.io/node-oracledb/INSTALL.html#quickstart). Example of OracleDB in javascript along with connection details can be found [here](https://github.com/oracle/node-oracledb/tree/master/examples). More samples [here](https://jsao.io/2018/03/creating-a-rest-api-with-node-js-and-oracle-database/).
